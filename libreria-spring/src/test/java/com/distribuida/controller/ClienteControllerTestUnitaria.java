...
public class ClienteControllerTestUnitaria {
    ...
    public void setUp(){
        ...
        cliente.setCedula("1763289134");
        cliente.setNombre("Lamine");
        cliente.setApellido("Yamal");
        cliente.setDireccion("España");
        cliente.setTelefono("0952784593");
        cliente.setCorreo("lyamal@gmail.com");
    }
    ...
    public void testSave(){
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals("Lamine", respuesta.getBody().getNombre());
    }

...
public class ClienteServicioTestUnitaria {
    ...
    public void setUp(){
        ...
        cliente.setCedula("1753286798");
        cliente.setNombre("Neymar");
        cliente.setApellido("Da Silva");
        cliente.setDireccion("Santos");
        cliente.setTelefono("0963458729");
        cliente.setCorreo("neymars@gmail.com");
    }
    ...
    public void testSave(){
        ...
        assertEquals("Neymar", cliente1.getNombre());
    }
    ...
    public void testUpdateExistente(){
        ...
        clienteActualizado.setCedula("1734926843");
        clienteActualizado.setNombre("Lamine");
        clienteActualizado.setApellido("Yamal");
        clienteActualizado.setDireccion("España");
        clienteActualizado.setTelefono("0942785409");
        clienteActualizado.setCorreo("lyamal@gmail.com");
        ...
        assertEquals("Lamine", clienteResultado.getNombre());
